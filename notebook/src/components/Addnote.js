      ...
      <div className="container my-3">
        ...
        <form className='bg-dark text-white p-2 rounded'>
          <div className="form-group m-3">
            ...
            <input type="text" className="form-control my-2" id="title" name='title' onChange={onChange} aria-describedby="emailHelp" placeholder="Enter title" value={note.title} minLength={2} required />
          ...
          <label htmlFor="description">DESCRIPTION</label>
            <textarea class="form-control my-2" id="exampleFormControlTextarea1" rows="8" name='description' onChange={onChange} placeholder="Enter description"  value={note.description} minLength={5} required></textarea>
          </div>
          
          <div className="form-group m-3">
            <label htmlFor="tag">TAG</label>
            <input type="text" className="form-control my-2" id="tag" name='tag' onChange={onChange} placeholder="Enter tag" value={note.tag} minLength={1} required />
          </div>


          <button disabled={note.title.length < 2 || note.description.length < 5 || note.tag.length < 1} type="submit" className="btn btn-secondary m-3" onClick={handleClick}>ADD</button>
