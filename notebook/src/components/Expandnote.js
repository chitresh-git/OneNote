...
const Expandnote = (props) => {
    ...
    return (
        <div>
            <div className="container my-3 expandednote">

                <form className='bg-dark text-white p-2 rounded'>
                    <div className="form-group m-3">
                        <label htmlFor="title">TITLE</label>
                        <input type="text" className="form-control my-1" id="title" name='title' aria-describedby="emailHelp" value={selectednote.title} readOnly />
                    ...
                    <div class="m-3">
                        ...
                        <textarea class="form-control my-1" id="exampleFormControlTextarea1" rows='12' name='description' value={selectednote.description} readOnly></textarea>
                    </div>

                    <div className="form-group m-3">
                        <label htmlFor="tag">TAG</label>
                        <input type="text" className="form-control my-1" id="tag" name='tag' value={selectednote.tag} readOnly />
                    </div>
